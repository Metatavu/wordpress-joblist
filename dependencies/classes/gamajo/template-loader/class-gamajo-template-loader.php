...
if ( ! class_exists( 'JobList_Gamajo_Template_Loader' ) ) {
	 ...
	 *
	 * When using in a plugin, create a new class JobList_that extends this one and just overrides the properties.
	 *
	 * @package Gamajo_Template_Loader
	 * @author  Gary Jones
	 */
	class JobList_Gamajo_Template_Loader {
		/**
